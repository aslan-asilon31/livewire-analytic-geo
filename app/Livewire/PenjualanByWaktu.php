...
class PenjualanByWaktu extends Component
{
    ...
    public function mount()
    {
        ...
        $this->locations = [
            ...
            // wilayah jakarta
            [
                'city' => 'Cabang Jakarta - Umeda',
                'latitude' => -6.136240,
                'longitude' => 106.788331,
                'sales' => 2500000,
                'transactions' => 75,
                'monthly_transactions' => $this->generateMonthlyData($bulan)
            ],
            ...
            [
                'city' => 'Cabang Jakarta - KBN',
                'latitude' => -6.136246,
                'longitude' => 106.788422,
                'sales' => 2500000,
                'transactions' => 80,
                'monthly_transactions' => $this->generateMonthlyData($bulan)
            ],
            ...
            [
                'city' => 'Cabang Jakarta - 05',
                'latitude' => -6.148773,
                'longitude' => 106.778389,
                'sales' => 2500000,
                'transactions' => 130,
                'monthly_transactions' => $this->generateMonthlyData($bulan)
            ],
            ...
            [
                'city' => 'Cabang Jakarta - 89',
                'latitude' => -6.147866,
                'longitude' => 106.774144,
                'sales' => 2500000,
                'transactions' => 90,
                'monthly_transactions' => $this->generateMonthlyData($bulan)
            ],
