<div>
  ...
  <div class="mb-6">
    ...
    <div class="space-x-2">
      ...
      <button onclick="openCabangDetail('Cabang Jakarta - Umeda')"
        class="px-4 py-2 bg-blue-700 text-white rounded">Jakarta - Umeda</button>
      <button onclick="openCabangDetail('Cabang Jakarta - KBN')"
        class="px-4 py-2 bg-blue-600 text-white rounded">Jakarta - KBN</button>
      <button onclick="openCabangDetail('Cabang Jakarta - 05')" class="px-4 py-2 bg-blue-500 text-white rounded">Jakarta
        - 05</button>
      <button onclick="openCabangDetail('Cabang Jakarta - 89')" class="px-4 py-2 bg-blue-400 text-white rounded">Jakarta
        - 89</button>
      <button onclick="openCabangDetail('Bandung')" class="px-4 py-2 bg-purple-700 text-white rounded">Bandung</button>
      <button onclick="openCabangDetail('Semarang')"
        class="px-4 py-2 bg-yellow-600 text-white rounded">Semarang</button>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      locations.forEach(loc => {
        ...
        L.marker([loc.latitude, loc.longitude]).addTo(map)
          .bindTooltip(`
                        ...
                        🧾 ${'loc.transactions'} transaksi <br>
                        link: <a href="https://www.google.com/maps?q=${loc.latitude},${loc.longitude}" target="_blank">View on Google Maps</a>
                    `, {
            permanent: true,
            direction: 'top',
            offset: [0, -10],
      ...
      const datasets = locations.map(loc => ({
        ...
        backgroundColor: 'rgba(' + Math.floor(Math.random() * 255) + ',' + Math.floor(Math.random() * 255) +
